          ...
          <div className="glass-card p-6 md:p-10 relative z-10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-normal mb-4 flex items-center gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-6">
                  {/* Apple App Store */}
                  <a
                    href="https://tally.so/r/NpMyL0" target="_blank"
                  ...
                  <div className="phone-mockup w-44 relative z-10 animate-float-premium">
                    <div className="phone-screen aspect-[9/19.5] p-3 flex flex-col items-center justify-center">
                      <div className="w-12 h-12 flex items-center justify-center mb-3">
                        <img src={sn_logo_blue} alt="SN Logo" style={{ borderRadius: '0.6rem' }} className="w-full h-auto" />
                      </div>
                      <p className="text-foreground font-semibold text-xs mb-0.5">SN</p>
